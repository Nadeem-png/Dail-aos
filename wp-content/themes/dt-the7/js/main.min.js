...
jQuery.easing.jswing = jQuery.easing.swing, jQuery.extend(jQuery.easing, {
    ...
    function(t, e) {
        ...
        return function(t, e, i, s) {
            ...
            n.extend(a, s);
            var r, l, d, c, h, u, p, f, m, g, v, w, y, b, C, _, x, I, S, T, k, z, L, E, M, A, P, O, D, H, F, W, B, R, j, $, G, Y, N, q, U, V, X, Z, Q, K, J, tt, et, it, st, nt, ot, at, rt, lt, dt = {
                    x: 0,
                    y: 0
                },
                ct = {
                ...
                jt = function(t, e, i, s) {
                    return s === o.currItem.initialZoomLevel ? (i[t] = o.currItem.initialPosition[t], !0) : (i[t] = Pt(t, s), i[t] > e.min[t] ? (i[t] = e.min[t], !0) : i[t] < e.max[t] && (i[t] = e.max[t], !0))
                },
                $t = function(t) {
                    var e = "";
                ...
                qt = 0,
                Ut = function(t) {
                    Nt[t] && (Nt[t].raf && A(Nt[t].raf), qt--, delete Nt[t])
                },
                Vt = function(t) {
                ...
                Qt = {
                    ...
                    init: function() {
                        if (!r && !l) {
                            var i;
                            o.framework = n, o.template = t, o.bg = n.getChildByClass(t, "pswp__bg"), P = t.className, r = !0, F = n.detectFeatures(), M = F.raf, A = F.caf, z = F.transform, D = F.oldIE, o.scrollWrap = n.getChildByClass(t, "pswp__scroll-wrap"), o.container = n.getChildByClass(o.scrollWrap, "pswp__container"), h = o.container.style, o.itemHolders = _ = [{
                                ...
                                function() {
                                    ...
                                    z = "left", n.addClass(t, "pswp--ie"), Mt = function(t, e) {
                                        e.left = t + "px"
                                    }, Et = function(t) {
                            ...
                            var d = "pswp--open ";
                            for (a.mainClass && (d += a.mainClass + " "), a.showHideOpacity && (d += "pswp--animate_opacity "), d += E ? "pswp--touch" : "pswp--notouch", d += F.animationName ? " pswp--css_animation" : "", d += F.svg ? " pswp--svg" : "", n.addClass(t, d), o.updateSize(), u = -1, gt = null, i = 0; i < 3; i++) Mt((i + u) * mt.x, _[i].el.style);
                    ...
                    destroy: function() {
                        St("destroy"), He && clearTimeout(He), t.setAttribute("aria-hidden", "true"), t.className = P, b && clearInterval(b), n.unbind(o.scrollWrap, f, o), n.unbind(window, "scroll", o), fe(), Xt(), xt = null
                    },
                    ...
                    goTo: function(t) {
                        var e = (t = _t(t)) - c;
                        gt = e, c = t, o.currItem = Re(c), pt -= e, At(mt.x * pt), Xt(), it = !1, o.updateCurrItem()
                    },
                    next: function() {
                        o.goTo(c + 1)
                    },
                    ...
                    updateCurrItem: function(t) {
                        if (0 !== gt) {
                            ...
                            if (!(t && i < 2)) {
                                ...
                                for (var s = 0; s < i; s++) gt > 0 ? (e = _.shift(), _[2] = e, u++, Mt((u + 2) * mt.x, e.el.style), o.setContent(e, c - i + s + 1 + 1)) : (e = _.pop(), _.unshift(e), u--, Mt(u * mt.x, e.el.style), o.setContent(e, c + i - s - 1 - 1));
                                if (et && 1 === Math.abs(gt)) {
                                    var n = Re(x);
                    ...
                    updateSize: function(e) {
                        ...
                        if (ut.x = o.scrollWrap.clientWidth, ut.y = o.scrollWrap.clientHeight, Yt(), mt.x = ut.x + Math.round(ut.x * a.spacing), mt.y = ut.y, At(mt.x * pt), St("beforeResize"), void 0 !== u) {
                            for (var s, r, l, d = 0; d < 3; d++) s = _[d], Mt((d + u) * mt.x, s.el.style), l = c + d - 1, a.loop && je() > 2 && (l = _t(l)), (r = Re(l)) && (C || r.needsUpdate || !r.bounds) ? (o.cleanSlide(r), o.setContent(s, l), 1 === d && (o.currItem = r, o.updateCurrZoomItem(!0)), r.needsUpdate = !1) : -1 === s.index && l >= 0 && o.setContent(s, l), r && r.container && (qe(r, ut), Ze(r), Et(r));
                            C = !1
                        }
                    ...
                    if (Q) {
                        ...
                        if (0 !== t)
                            if (Ot(Kt, Q[0]), te.x = Kt.x - ee.x, te.y = Kt.y - ee.y, K && t > 1) {
                                ...
                                s < 0 && (s = 0), e, be(Kt, Jt, le), dt.x += le.x - ue.x, dt.y += le.y - ue.y, Ot(ue, le), ht.x = Pt("x", i), ht.y = Pt("y", i), $ = i > g, g = i, Lt()
                            } else {
                                if (!st) return;
                ...
                Ee = function(t) {
                    ...
                    if (0 === l && (N = !1, n.unbind(window, p, o), fe(), K ? d = 0 : -1 !== de && (d = Tt() - de)), de = 1 === l ? Tt() : -1, s = -1 !== d && d < 150 ? "zoom" : "swipe", K && l < 2 && (K = !1, 1 === l && (s = "zoomPointerUp"), St("zoomGestureEnded")), Q = null, V || U || it || G)
                        if (Xt(), j || (j = Me()), j.calculateSwipeSpeed("x"), G) {
                            ...
                            if (!it) return "swipe" !== s ? void De() : void(!Z && g > o.currItem.fitRatio && Ae(j))
                        }
                },
                Me = function() {
                    var t, e, i = {
                ...
                Pe = function(t, e) {
                    ...
                    var h, u = mt.x * pt,
                        p = Math.abs(u - ce.x);
                    return i || u > ce.x == e.lastFlickSpeed.x > 0 ? (h = Math.abs(e.lastFlickSpeed.x) > 0 ? p / Math.abs(e.lastFlickSpeed.x) : 333, h = Math.min(h, 400), h = Math.max(h, 250)) : h = 333, re === c && (i = !1), it = !0, St("mainScrollAnimStart"), Zt("mainScroll", ce.x, u, h, n.easing.cubic.out, At, (function() {
        ...
        return function(t, e) {
            var i, s, n, o, a, r, l, d, c, h, u, p, f, m, g, v, w, y, b = this,
                ...
                A = function() {
                    ...
                    l.children[0].innerHTML = n, l.children[0].onclick = M
                },
                P = function(t) {
            ...
            b.init = function() {
                ...
                if (!v)
                    ...
                    } else if (g.tapToToggleControls && (_ ? b.hideControls() : b.showControls()), g.tapToClose && (e.hasClass(s, "pswp__img") || P(s))) return void t.close()
    ...
    function(t, e, i, s) {
        ...
        t.fn.Filterade = function(e) {
            var i, s, o, a, r, l, d, c, h, u, p, f, m, g, v, w, y, b, C, _, x, I, S;
            l = {
                useFilters: !1,
                useSorting: !1,
                ...
                activeClass: "act",
                log: !1
            }, r = t(this), I = e.customSorters || {}, v = e.paginationMode || l.paginationMode, w = t(e.pageControls || l.pageControls), d = t(e.filterControls || l.filterControls), c = t(e.sortControls || l.sortControls), h = t(e.orderControls || l.orderControls), u = e.controlsSelecter || l.controlsSelecter, p = e.controlsSelecterChecked || l.controlsSelecterChecked, s = 1, x = r.parent().hasClass("show-all-pages") ? 999 : 5;
            ...
            return (g = t([])).$nodesCache = t([]), r.find("> article, .wf-cell").each((function() {
                ...
                })), y = Math.ceil(g.length / e.pageLimit), m = function() {
                    var t;
                    "pages" !== v && "load-more" !== v || (t = 0, g.each((function() {
                        if (this.$node.hasClass("visible")) return t++
                    })), y = Math.ceil(t / (e.pageLimit || l.pageLimit)))
                }, b = function() {
                    var i, n;
                    if ("pages" === v) {
                        if (w.empty(), w.addClass("hidden"), y > 1) {
                            w.removeClass("hidden"), 1 !== s && w.prepend('<a href="#" class="' + (e.previousButtonClass || l.previousButtonClass) + '">' + (e.previousButtonLabel || l.previousButtonLabel) + "</a>");
                            var o = x - 1,
                                a = Math.floor(o / 2),
                                d = Math.ceil(o / 2),
                                c = Math.max(s - a, 1),
                                h = s + d;
                            c <= a && (h = c + o), h > y && (c = Math.max(y - o, 1), h = y);
                            var u = '<a href="javascript:void(0);" class="dots">…</a>',
                                p = t('<div style="display: none;"></div>'),
                                f = t('<div style="display: none;"></div>');
                            for (i = n = 1; 1 <= y ? n <= y : n >= y; i = 1 <= y ? ++n : --n) i < c && 1 != i ? p.append('<a href="#" class="' + (e.pagerClass || l.pagerClass) + '" data-page="' + +i + '">' + i + "</a>") : (i == c && p.children().length && w.append(p).append(t(u)), i > h && i != y ? f.append('<a href="#" class="' + (e.pagerClass || l.pagerClass) + '" data-page="' + +i + '">' + i + "</a>") : (i == y && f.children().length && w.append(f).append(t(u)), w.append('<a href="#" class="' + (e.pagerClass || l.pagerClass) + '" data-page="' + +i + '">' + i + "</a>")));
                            s < y && w.append('<a href="#" class="' + (e.nextButtonClass || l.nextButtonClass) + '">' + (e.nextButtonLabel || l.nextButtonLabel) + "</a>"), w.find('a[data-page="' + s + '"]').addClass(e.activeClass || l.activeClass);
                            var m = e.pagerClass || l.pagerClass;
                            return m = m.trim().replace(" ", "."), w.find("a.dots").click((function(e) {
                                w.find("div:hidden a").unwrap(), t(this).remove()
                            })), w.find("a." + m).click((function(i) {
                                i.preventDefault(), s = parseInt(t(this).attr("data-page"));
                                var n = r.parent().attr("data-scroll-offset") ? parseInt(r.parent().attr("data-scroll-offset")) : 0;
                                if (w.find("a." + (e.activeClass || l.activeClass)).removeClass(e.activeClass || l.activeClass), w.find('a[data-page="' + s + '"]').addClass(e.activeClass || l.activeClass), r.hasClass("dt-css-grid")) var o = r.parent().offset().top - 40;
                            ...
                            })), w.find("a." + (e.previousButtonClass || l.previousButtonClass)).click((function(e) {
                                e.preventDefault(), s--;
                                var i = r.parent().attr("data-scroll-offset") ? parseInt(r.parent().attr("data-scroll-offset")) : 0;
                                if (r.hasClass("dt-css-grid")) var n = r.parent().offset().top - 40;
                                else n = r.offset().top - 40;
                                return !r.parent().hasClass("enable-pagination-scroll") && r.parent().hasClass("the7-elementor-widget") || t("html, body").animate({
                                    scrollTop: n - E + i
                                }, 400), _()
                            })), w.find("a." + (e.nextButtonClass || l.nextButtonClass)).click((function(e) {
                                e.preventDefault(), s++;
                                var i = r.parent().attr("data-scroll-offset") ? parseInt(r.parent().attr("data-scroll-offset")) : 0;
                                if (r.hasClass("dt-css-grid")) var n = r.parent().offset().top - 40;
                                else n = r.offset().top - 40;
                    ...
                    } else if ("load-more" === v && (w.addClass("hidden"), y > 1)) {
                        s < y && w.removeClass("hidden");
                        var g = e.loadMoreButtonClass || l.loadMoreButtonClass;
                        return g = g.trim().replace(" ", "."), w.find("a:not(.filtrade-ready)." + g).click((function(e) {
                            return e.preventDefault(), t(this).addClass("filtrade-ready"), !(s >= y) && (s++, _())
                        }))
                    }
                }, C = function() {
                    ...
                    if ("pages" === v || "load-more" === v) {
                        var n = 0,
                            ...
                            a = t([]);
                        g.each((function(t) {
                            this.$node.hasClass("visible") && (n++, "pages" === v && n > s * (e.pageLimit || l.pageLimit) - (e.pageLimit || l.pageLimit) && n <= (e.pageLimit || l.pageLimit) * s || "load-more" === v && n <= (e.pageLimit || l.pageLimit) * s ? a.push(this.node) : o.push(this.node))
                    ...
                    var s = t([]),
                        n = t([]);
                    e.useFilters || l.useFilters ? i === (e.selectAll || l.selectAll) ? n = g.$nodesCache : g.each((function(t) {
                        this.$node.hasClass(i.replace(/^\./, "")) ? n.push(this.node) : s.push(this.node)
                    })) : n = g.$nodesCache, s.removeClass("visible").addClass("hidden"), n.removeClass("hidden").addClass("visible")
                }, S = function() {
                    var e = "asc" === a ? 1 : -1;
                ...
                function() {
                    return (e.useFilters || l.useFilters) && (i = d.find(p).attr("data-filter") || e.defaultFilter || l.defaultFilter, d.find(u).click((function(e) {
                        i = t(this).attr("data-filter"), s = 1, _()
                        ...
                        o = "date" === this.getAttribute("data-by") ? "date" : "name", S(), s = 1, _()
                    })), h.find(u).click((function(t) {
                        a = "desc" === this.getAttribute("data-sort") ? "desc" : "asc", S(), s = 1, _()
                    }))), _()
                }()
        }
...
function(t) {
    ...
    function h() {
        ...
        function(t) {
            ...
            function E(t) {
                var e = t.data.event,
                    i = t.data.timer;
                s(document, r, L), s(document, d, E), P(e, i, (function() {
                    setTimeout((function() {
                        s(e.target, "click", m)
                    }), 0)
                }))
            ...
            function A(t) {
                ...
                w(t.changedTouches, e.identifier) && (! function(t) {
                    s(document, "." + t.identifier, M), s(document, "." + t.identifier, A)
                }(e), P(e, i))
            }
            ...
            t.event.special.movestart = {
                ...
                _default: function(t) {
                    ...
                    t._handled() && (s = {
                        ...
                        touch: e,
                        timeStamp: e
                    }, t.identifier === e ? (i(t.target, "click", m), i(document, r, L, o), i(document, d, E, o)) : (t._preventTouchmoveDefault(), i(document, c + "." + t.identifier, M, o), i(document, u + "." + t.identifier, A, o)))
                }
    ...
    var x = t(".top-bar"),
        ...
        M = t(".floating-navigation-below-slider").exists();
    ...
    if (t.closeSideHeader = function() {
        ...
        var A = dtLocal.themeSettings.ToggleCaptionEnabled;
        ToggleCaption = "disabled" != A ? "<span class='menu-toggle-caption'>" + dtLocal.themeSettings.ToggleCaption + "</span>" : "", T.length > 0 && r.append('<div class="sticky-header-overlay"></div>');
        var P = t(".menu-toggle"),
    ...
    function F() {
        ...
        if (r.hasClass("header-side-right") && l.hasClass("boxed") && !T.length > 0 && L.css({
                right: i
            }), navigator.userAgent.match(/Trident.*rv\:11\./) && M && E) {
            I.insertAfter(z);
            var n = I.attr("style");
    ...
    if (F(), o.on("resize", (function() {
            F()
        })), M && r.hasClass("footer-overlap") && I.insertAfter(z), navigator.userAgent.match(/Trident.*rv\:11\./) && M && E) {
        I.insertAfter(z);
        var W = I.attr("style");
    ...
    if (t(".sticky-mobile-header").exists() && !r.hasClass("responsive-off")) {
        ...
        t(".no-cssgridlegacy.no-cssgrid").length > 0 && ht && (E ? (ut.css({
            ...
            var e = dtGlobals.winScrollTop;
            e > wt && !yt && t(document).height() > t(window).height() ? (ut.removeClass("sticky-mobile-off").addClass("sticky-mobile-on"), M && ct && ut.addClass("fixed-mobile-header"), ut.css({
                top: mt - ft
            }), yt = !0) : e <= wt && yt && (ut.removeClass("sticky-mobile-on").addClass("sticky-mobile-off"), M && ct && ut.removeClass("fixed-mobile-header"), ut.css({
                top: 0
    ...
    if (dtLocal.themeSettings.floatingHeader.showMenu && Ct) {
        ...
        dtGlobals.resetSizes = function(e) {
            if (window.innerWidth <= dtLocal.themeSettings.mobileHeader.firstSwitchPoint && !r.hasClass("responsive-off")) return Mt || (Mt = !0, T.removeClass("sticky-off sticky-on"), E || Et.removeClass("sticky-space-off sticky-space-on"), T.css({
                top: "",
                transform: ""
    ...
    if (k.exists()) {
        ...
        dtGlobals.resetTopLineSizes = function(e) {
            if (window.innerWidth <= dtLocal.themeSettings.mobileHeader.firstSwitchPoint && !r.hasClass("responsive-off")) return Mt || (Mt = !0, k.removeClass("sticky-top-line-on"), k.css({
                top: ""
            }), Ot = !1), !1;
            Mt && (Mt = !1), It = t("#wpadminbar").exists() ? t("#wpadminbar").height() : 0, X = !x.exists() || x.is(":hidden") || x.hasClass("top-bar-empty") || x.hasClass("hide-top-bar") ? 0 : x.innerHeight(), Pt = k.find(".header-bar").height() + X, t(".top-line-space").css({
                height: Pt
        ...
        if (Ht || Ft) {
            ...
            if (Wt) {
                var $t = I.attr("class"),
                    ...
                    Yt = (Pe = t('<div id="phantom" class="' + $t + '"><div class="ph-wrap"></div></div>').appendTo("body")).find(".ph-wrap"),
                    Nt = Pe.find(".widget-box"),
                ...
                $t = I.attr("class"), Yt = (Pe = t('<div id="phantom" class="' + $t + '"><div class="ph-wrap"><div class="logo-box"></div><div class="menu-box"></div><div class="widget-box"></div></div></div>').appendTo("body")).find(".menu-box"), Nt = Pe.find(".widget-box");
                if (t(".classic-header").length > 0) qt = t(".header-bar .navigation .mini-widgets").clone(!0);
                else if (Wt);
                else qt = t(".header-bar .mini-widgets").clone(!0);
                Bt.appendTo(Yt), qt.appendTo(Nt), r.hasClass("floating-top-bar") && Rt.prependTo(Pe), dtLocal.themeSettings.floatingHeader.logo.html && dtLocal.themeSettings.floatingHeader.logo.showLogo && (Pe.find(".ph-wrap").addClass("with-logo"), null == _t ? Pe.find(".logo-box").html('<a href="' + dtLocal.themeSettings.floatingHeader.logo.url + '">' + dtLocal.themeSettings.floatingHeader.logo.html + " </a>") : Pe.find(".logo-box").html('<a href="' + _t + '">' + dtLocal.themeSettings.floatingHeader.logo.html + " </a>"))
            }
            var Vt, Xt = t("#phantom");
            l.hasClass("boxed") && Pe.addClass("boxed").find(".ph-wrap").addClass("boxed"), Xt.removeClass("show-phantom").addClass("hide-phantom").css("visibility", "hidden"), dtGlobals.addOnloadEvent((function() {
    ...
    function ce() {
        t(".preload-me").loaded(null, (function() {
            ...
            if (t(".floating-content").length > 0) {
                ...
                o.on("scroll", (function() {
                    window.innerWidth > 1050 ? dtGlobals.winScrollTop + Pe.height() > n.top ? dtGlobals.winScrollTop + Pe.height() + s + 40 < r.top + i ? e.css("transform", "translateY(" + (dtGlobals.winScrollTop - n.top + Pe.height() + 5 - a) + "px)") : e.css("transform", "translateY(" + (i - s - 40 - a) + "px)") : e.css("transform", "translateY(0px)") : e.css({
                        transform: "translateY(0)"
                    })
                }))
            }
    ...
    !me.length && t("form.checkout").exists() && (me = t("form.checkout").parents(".content").offset().top), t(document.body).on("checkout_error", (function() {
            t("html, body").animate({
                scrollTop: me - Pe.height()
            }, "slow")
        })),
        /*!-Custom select*/
        t('<svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 16 16" style="enable-background:new 0 0 16 16;" xml:space="preserve"><path class="st0" d="M2.5,12c0-0.3,0.2-0.5,0.5-0.5h10c0.3,0,0.5,0.2,0.5,0.5s-0.2,0.5-0.5,0.5H3C2.7,12.5,2.5,12.3,2.5,12z M2.5,8c0-0.3,0.2-0.5,0.5-0.5h10c0.3,0,0.5,0.2,0.5,0.5c0,0.3-0.2,0.5-0.5,0.5H3C2.7,8.5,2.5,8.3,2.5,8z M2.5,4c0-0.3,0.2-0.5,0.5-0.5h10c0.3,0,0.5,0.2,0.5,0.5S13.3,4.5,13,4.5H3C2.7,4.5,2.5,4.3,2.5,4z"/></svg><select aria-label="Dropdown menu"/>').prependTo("#bottom-bar .mini-nav .menu-select"), t("<option />", {
            selected: "selected",
            value: "",
            text: "———"
    ...
    if (jQuery(".wpcf7").each((function() {
        ...
        if (X = !x.exists() || x.is(":hidden") || x.hasClass("top-bar-empty") || x.hasClass("hide-top-bar") ? 0 : x.innerHeight(), Ht || Ft) var ye = t(Pe).height() + 20;
    ...
    n.on("elementor/popup/show", be, (function(e, i, s) {
        ...
        var e = t.parent().hasClass("mode-masonry") ? t.parent() : t,
            ...
            s = "data-mobile-columns-num";
        e.hasClass("products-shortcode") && (i = "data-v-tablet-columns-num", s = "data-phone-columns-num");
        var n = t.width() - 1,
        ...
        return Modernizr.mq("all and (min-width:" + (dtLocal.elementor.settings.container_width + 1) + "px)") ? (a = parseInt(e.attr("data-wide-desktop-columns-num")), {
            singleWidth: Math.floor(n / a) + "px",
            doubleWidth: 2 * Math.floor(n / a) + "px",
            columnsNum: a
        }) : ([{
            breakpoint: o.xl,
            ...
            breakpoint: o.md,
            columns: parseInt(e.attr(s))
        }].forEach((function(t) {
            if (Modernizr.mq("all and (max-width:" + (t.breakpoint - 1) + "px)")) return a = t.columns, r = Math.floor(n / a) + "px", l = 2 * Math.floor(n / a) + "px", !1
        })), {
            singleWidth: r,
            doubleWidth: l,
            columnsNum: a
    ...
    Se.not(".blog-grid-shortcode").addClass("dt-isotope"), window.the7ApplyColumns = function(t, e, i) {
        ...
        if (dtGlobals.resizeCounter++, the7Utils.isFunction(t.fn.calcPics) && t(".instagram-photos").calcPics(), l.hasClass("boxed")) {
            var i = l.css("maxWidth"),
                s = i.indexOf("px") >= 0,
                n = i.indexOf("%") >= 0;
            s && (I.addClass("width-in-pixel"), void 0 !== Pe && Pe.addClass("width-in-pixel")), n && (t(".masthead.full-width:not(.side-header)").css({
                width: l.width()
            }), void 0 !== Pe && Pe.find(".top-bar-bg").length > 0 && Pe.find(".top-bar-bg").css({
                width: l.width()
    ...
    var ke = t("html, body"),
        ...
        Me = t(".sticky-mobile-header").exists(),
        Ae = Ct || Ee,
        Pe = null;
    we = null;

    function Oe() {
        window.innerWidth < dtLocal.themeSettings.mobileHeader.firstSwitchPoint && !r.hasClass("responsive-off") ? Me && (Pe = t(".masthead-mobile-header")) : Pe = Ae ? t(".masthead") : Me && !t(".mobile-false").length > 0 ? t(".masthead-mobile-header") : t("#phantom");
    ...
    o.scroll((function(e) {
        if (!r.hasClass("is-scroll")) {
            var i, s = null;
            s = jt && "solid" == Pe.css("border-bottom-style") ? Pe.height() + 1 : jt ? Pe.height() : we.height(), t(".masthead.side-header").length > 0 && null == s && (s = 0), null == s && (s = 0);
